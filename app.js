...
client.on('message', (message) => {
    onmessage(levelworker, antispamworker, client, con, Math, Jimp, downloader, webp, fs, pdf, moment, msi, emojiStrip, message, Intents, MessageEmbed, MessageReaction, MessageCollector, MessageAttachment);
});
