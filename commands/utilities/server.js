...
module.exports = {
  ...
  runInteraction (locale, interaction) {
    const serverInfo = new MessageEmbed()
      ...
      .setDescription(
				`:medal: **${i18n(locale, 'SERVER::EMBED:SERVERNAME')}**: ${interaction.guild.name
				}\n:id: **${i18n(locale, 'SERVER::EMBED:SERVERID')}**: ${interaction.guild.id
				}\n:calendar: **${i18n(
					locale,
					'SERVER::EMBED:SERVERCREATIONDATE'
				)}**: <t:${unixTime(
				...
				}\n<a:nitro:927222194034053161> **${i18n(
					locale,
					'SERVER::EMBED:NITROSTATUS'
				)}**: ${interaction.guild.premiumTier} (${interaction.guild.premiumSubscriptionCount || '0'
				})`
      )
      .setFooter({
  ...
  runCommand (locale, message) {
    const serverInfo = new MessageEmbed()
      ...
      .setDescription(
				`:medal: **${i18n(locale, 'SERVER::EMBED:SERVERNAME')}**: ${message.guild.name
					...
					locale,
					'SERVER::EMBED:NITROSTATUS'
				)}**: ${message.guild.premiumTier} (${message.guild.premiumSubscriptionCount || '0'
				})`
      )
      .setFooter({
        text: 'Powered by Pingu',
