...
module.exports = {
  ...
  runInteraction (interaction) {
    const serverInfo = new EmbedBuilder()
      ...
      .setDescription(`:medal: **${i18n(interaction.guild.preferredLocale, 'SERVER::EMBED:SERVERNAME')}**: ${interaction.guild.name}\n:id: **${i18n(interaction.guild.preferredLocale, 'SERVER::EMBED:SERVERID')}**: ${interaction.guild.id}\n:calendar: **${i18n(interaction.guild.preferredLocale, 'SERVER::EMBED:SERVERCREATIONDATE')}**: <t:${unixTime(interaction.guild.createdTimestamp)}>\n:crown: **${i18n(interaction.guild.preferredLocale, 'SERVER::EMBED:SERVEROWNER')}**: ${process.Client.users.cache.get(interaction.guild.ownerId).tag}\n<a:nitro:927222194034053161> **${i18n(interaction.guild.preferredLocale, 'SERVER::EMBED:NITROSTATUS')}**: ${interaction.guild.premiumTier} (${interaction.guild.premiumSubscriptionCount || '0'})`)
