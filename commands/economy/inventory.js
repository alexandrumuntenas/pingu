      ...
      getMember(client, interaction.member, (memberData) => {
        ...
        if (memberData) {
          ...
          if (inventoryDataProducts.length > 0) {
                ...
                getShopProduct(
                  ...
                  (productData) => {
                    ...
                    if (productData && product !== -1)
                      inventoryString += `${
                        productData.productName || "Non existent item"
                      } - (x${product})\n`;
                    if (
                      inventoryDataProductsIndex ===
                      inventoryDataProducts.length
                    ) {
                      if (!inventoryString)
                        inventoryEmbed.setImage(
                          "https://cdn.discordapp.com/attachments/908413370665938975/927155718115688488/empty_inventory.png"
                        );
                      else {
                        inventoryEmbed.setThumbnail(
                          "https://cdn.discordapp.com/attachments/908413370665938975/917086976744767498/inventory_chest.png"
                        );
                      }
                      inventoryEmbed.setDescription(
                        inventoryString ||
                          i18n(locale, "INVENTORY::EMBED:EMPTY")
                      );
            ...
            inventoryEmbed
              .setDescription(i18n(locale, "INVENTORY::EMBED:EMPTY"))
              .setImage(
                "https://cdn.discordapp.com/attachments/908413370665938975/927155718115688488/empty_inventory.png"
              );
            interaction.editReply({ embeds: [inventoryEmbed] });
