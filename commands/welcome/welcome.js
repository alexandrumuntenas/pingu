...
module.exports = {
  ...
  runInteraction (locale, interaction) {
    switch (interaction.options.getSubcommand()) {
      case 'setchannel': {
        actualizarConfiguracionDelGuild(interaction.guild, { column: 'welcome', newconfig: { channel: interaction.options.getChannel('channel').id } }, err => {
      ...
      case 'setmessage': {
        actualizarConfiguracionDelGuild(interaction.guild, { column: 'welcome', newconfig: { message: interaction.options.getString('message') } }, err => {
      ...
      case 'configurecards': {
        ...
        if (sendcards || backgroundurl || overlayopacity || overlaycolor || title || subtitle) {
          ...
          if (title) {
            modifiedconfig.addField(`:writing_hand: ${i18n(locale, 'TITLE')}`, title || `❌ ${i18n(locale, 'NOTSET')}`, true)
            newconfig.welcomecard.title = title
          }

          if (subtitle) {
            modifiedconfig.addField(`:writing_hand: ${i18n(locale, 'SUBTITLE')}`, subtitle || `❌ ${i18n(locale, 'NOTSET')}`, true)
            newconfig.welcomecard.subtitle = subtitle
          }

          actualizarConfiguracionDelGuild(interaction.guild, { column: 'welcome', newconfig }, err => {
  ...
  runCommand (locale, message) {
    ...
    switch (message.parameters[0].toLowerCase()) {
      ...
      case 'setchannel': {
        ...
        actualizarConfiguracionDelGuild(message.guild, { column: 'welcome', newconfig: { channel: message.mentions.channel.first().id } }, err => {
      ...
      case 'setmessage': {
        ...
        actualizarConfiguracionDelGuild(message.guild, { column: 'welcome', newconfig: { message: message.parameters.slice(1).join(' ') } }, err => {
        ...
        switch (message.parameters[1].toLowerCase()) {
          case 'sendcards': {
            if (message.parameters[2] === 'true') {
              actualizarConfiguracionDelGuild(message.guild, { column: 'welcome', newconfig: { welcomecard: { enabled: true } } }, err => {
              ...
              actualizarConfiguracionDelGuild(message.guild, { column: 'welcome', newconfig: { welcomecard: { enabled: false } } }, err => {
                if (err) return message.channel.send({ embeds: [plantillas.error(i18n(locale, 'WELCOME::CONFIGURECARDS:SENDCARDS:ERROR'))] })
          ...
          case 'backgroundurl': {
            actualizarConfiguracionDelGuild(message.guild, { column: 'welcome', newconfig: { welcomecard: { background: message.parameters.slice(2).join(' ') } } }, err => {
          ...
          case 'overlayopacity': {
            ...
            actualizarConfiguracionDelGuild(message.guild, { column: 'welcome', newconfig: { welcomecard: { overlay: { opacity: parseInt(message.parameters[2], 10) } } } }, err => {
          ...
          case 'overlaycolor': {
            ...
            actualizarConfiguracionDelGuild(message.guild, { column: 'welcome', newconfig: { welcomecard: { overlay: { color: message.parameters[2] } } } }, err => {
          ...
          case 'title': {
            actualizarConfiguracionDelGuild(message.guild, { column: 'welcome', newconfig: { welcomecard: { title: message.parameters.slice(2).join(' ') } } }, err => {
          ...
          case 'subtitle': {
            actualizarConfiguracionDelGuild(message.guild, { column: 'welcome', newconfig: { welcomecard: { subtitle: message.parameters.slice(2).join(' ') } } }, err => {
