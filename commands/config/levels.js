...
module.exports = {
  ...
  interactionData: new SlashCommandBuilder()
    ...
    .addSubcommand((subcommand) => subcommand.setName('setrankupchannel').setDescription('Set the rankUp channel').addStringOption((option) => option.setName('channel')
...
.setRequired(true)))
    .addSubcommand((subcommand) => subcommand.setName('configurecard').setDescription('Configure the rank card').addNumberOption((option) => option.setName('setoverlayopacity').setDescription('Enter a number')).addStringOption((option) => option.setName('setoverlaycolor').setDescription('Enter a hex color'))
.addStringOption((option) => option.setName('setbackgroundurl').setDescription('Enter a valid image URL')))
