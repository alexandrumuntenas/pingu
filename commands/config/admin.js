...
.setRequired(true)))
.addSubcommand((sc) => sc.setName('disable').setDescription('Disable a module').addStringOption((so) => so.setName('module').setDescription('The name of the module to disable.').addChoice('Autoresponder', 'autoresponder').addChoice('Welcomer', 'welcomer')
.addChoice('Join Roles', 'joinroles')
.addChoice('Farewell', 'farewell')
.addChoice('Leveling', 'leveling')
.addChoice('Custom Commands', 'customcommands')
