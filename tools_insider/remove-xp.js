                ...
                if (parseInt(args[1])) {
                    if (parseInt(args[1]) <= 9999) {
                        if (args[2]) {
                            ...
                            message.channel.send(":information_source: El tercer argumento debe ser un @usuario :arrow_right: https://wiredpenguin.duoestudios.es/modulos/niveles#moderadores");
                        }
                    } else {
                        message.reply(":scream: ¿A donde vás flipado? Introduce un valor númerico entre 0 - 9999 :arrow_right: https://wiredpenguin.duoestudios.es/modulos/niveles#moderadores");
                    }
                } else {
                    message.reply(":information_source: El segundo argumento debe ser un valor númerico :arrow_right: https://wiredpenguin.duoestudios.es/modulos/niveles#moderadores");
                }
            }
        } else {
