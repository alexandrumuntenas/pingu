...
module.exports = {
  levelsCard: async (client, member, locale, database) => {
    ...
    StackBlur.canvasRGBA(canvas, 25, 25, 1050, 450, database.levelsImageCustomBlur)
    ...
    if (database.levelsImageRoundAvatar === 1) {
      ctx.beginPath()
